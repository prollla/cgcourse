...
import com.vsu.cgcourse.obj_reader.DeletePolygons;
...
public class GuiController {
    ...
    private final String URL = "C:\\Users\\Антон\\IdeaProjects\\Average3DViewer-918e3a8610efcfdf62f68eca62755ad448315590\\src\\main\\resources\\com\\vsu\\cgcourse\\photos";
    ...
    private void initialize() {
        ...
        saveButton.setOnAction(event -> {
            ...
            controller.setUnmoddedMesh(unmoddedMesh);
            stage.show();
        });
    ...
    private void onOpenModelMenuItemClick2() {
        ...
        try {
            String fileContent = Files.readString(fileName);
            if (mesh != null) {
                mesh = DeletePolygons.readingAndDeletingPolygons(fileContentModel, fileContent);
            } else {
    ...
    public void windowCallDeletePolygon() {
        ...
        newWindow.show();
        button.setOnAction(actionEvent ->
                DeletePolygons.createDeleteArray(mesh, deleteArray.getText()));
